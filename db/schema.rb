...
ActiveRecord::Schema.define(version: 20170304071040) do
  ...
  create_table "products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.integer  "rent_status", default: 2
    t.integer  "user_id"
  end

  create_table "rental_records", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
